    ...
    pub fn ialloc_alloc_inode(&self, is_dir: bool) -> Result<u32> {
        ...
        while bgid <= bg_count {
            ...
            if free_inodes > 0 {
                ...
                // Keep the bitmap and the free-inode counters authoritative
                // together.  A stale counter must not make us set the
                // default index (inode 0 in this group) a second time.
